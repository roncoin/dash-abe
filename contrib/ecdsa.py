...
<body>
  <div id="logo">
   <a href="%(dotdot)s/">
    <img src="http://s3.ecdsa.org/bc_logo.png" alt="Dagra logo" border="none" />
   </a> 
  </div>
  <div id="navigation">
    <ul>
...
&nbsp;&nbsp;source:<a href="ecdsa.py">[1]</a>&nbsp;<a href="abe.diff">[2]</a>
    ...
    def handle_thresholdRelease(abe, page):
        ...
        if address:
            ...
            """
            msg= """
This service allows you to release digital content when a requested amount of Dagra donations has been reached.<br/>
<br/>
...
"""
    ...
    def handle_widgets(abe, page):
        ...
        text = "Donate"
        link_text  = "<a style=\"text-decoration:none;color:"+textcolor+"\" href=\"javascript:alert('Donate to this Dagra address:\\n"+address+"');\">"+text+"</a>"
